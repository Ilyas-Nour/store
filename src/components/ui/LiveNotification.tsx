...
const cities = ["New York", "London", "Paris", "Berlin", "Dubai", "Sydney", "Toronto", "Riyadh", "Madrid", "Tokyo"];
const plans = ["1-Year Premium", "6-Month Elite", "3-Month Access"];
    ...
    <AnimatePresence>
      {notification && (
        <motion.div
          ...
          className="fixed bottom-8 left-8 z-[100] z-50"
        >
          <div className="bg-[#0f172a]/90 backdrop-blur-2xl border border-white/10 p-4 rounded-2xl shadow-2xl flex items-center gap-4 min-w-[280px]">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 font-bold uppercase tracking-tighter">
                started a <span className="text-brand-gold">{notification.plan}</span>
              </p>
            </div>
          </div>
        </motion.div>
